    ...
    func loadCharsFromJSON() -> [ChineseChar]? {
        ...
        do {
            ...
            for char in array{
                ...
                guard let strks = charDict["strokes"] as? [String] else {print("Missing Strokes"); return nil}
                
                let curChar = ChineseChar(character: hanzi, pts: pts, def: definition, pin: pinyin, decomp: decomposition, rad: radical, strkes: strks)
